...
public class LocaleTest01 {
    public static void main(String[] args) {
        ...
        System.out.println(localeItaly.getDisplayCountry()); // Mostra o país do locale criado.
        System.out.println(localeItaly.getDisplayCountry(localeJapao)); // Mostra o país do locale criado, só que agora em japones.
